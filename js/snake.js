(function () {
  ...
  var Snake = SG.Snake = function(board) {
    ...
    this.segments = [];
    this.board = board;
    this.segments.push(new SG.Coord(this.board.size / 2, this.board.size / 2));
  };
  ...
  Snake.prototype.snack = function() {
    ...
    this.segments.push(new SG.Coord(newI, newJ));
  ...
  Snake.prototype.move = function() {
    var newSegment = new SG.Coord(this.segments[0].i, this.segments[0].j);
